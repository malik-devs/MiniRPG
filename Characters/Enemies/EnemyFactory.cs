...
namespace MiniRPG.Characters.Enemies
{
    public class EnemyFactory
    {
        ...
        {
            enemies.Add(new Enemy("Goblin Scout", 35, 8, 15, 10, 1, 3));
            enemies.Add(new Enemy("Skeleton Warrior", 60, 14, 30, 22, 2, 5));
            enemies.Add(new Enemy("Wild Orc", 110, 22, 65, 45, 4, 7));
            enemies.Add(new Enemy("Shadow Assassin", 150, 40, 90, 70, 6, 9));
            enemies.Add(new Enemy("Stone Golem", 220, 45, 150, 140, 8, 10));
        }
